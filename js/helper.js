...
var HTMLonlineClasses = '<h3 id="onlineTitle">Online Classes</h3>';
...
$(document).ready(function() {
  $('button').click(function() {
    var iName = inName("Jason Carvalho") || function(){};
    $('#name').html(iName);  
  });
});

// Function for International button
function inName(name)
{
  var internationalName = name;
  internationalName = internationalName.split(" ");
